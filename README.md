...
| Repository | Program | Focus | Status |
|-----------|---------|-------|--------|
| [Production AI Systems](https://github.com/ASebastianAiX/APOLLO-AiX-Production-Systems) | Independent | 20+ live deployed AI systems — Healthcare, Fitness, Real Estate, Small Business | Active |
| [BSU GenAI Bootcamp](https://github.com/ASebastianAiX/BSU-GenAI-Bootcamp-Portfolio) | Business Science University | RAG, LangGraph, Multi-Agent Systems, AI Forecasting | Active |
| [UT Austin AI/ML](https://github.com/ASebastianAiX/UT-Austin-AIML-Portfolio) | UT Austin McCombs | Machine Learning, Classification, Predictive Analytics | 2/6 complete |
| [Purdue AI Engineering](https://github.com/ASebastianAiX/Purdue-AI-Engineering-Portfolio) | Purdue / Simplilearn | AI Engineering, Python, GitHub Copilot, Data Analysis | Active |
| [JHU Cybersecurity](https://github.com/ASebastianAiX/JHU-Cybersecurity-Portfolio) | Johns Hopkins Whiting | IT & Data Security, Secure AI Systems | In Progress |
| [Purdue Data Engineering](https://github.com/ASebastianAiX/Purdue-Data-Engineering-Portfolio) | Purdue / Simplilearn | ETL Pipelines, Data Warehousing, Apache Airflow | Enrolled |
...
**Generative AI & LLMs**
RAG pipelines · LangChain · LangGraph · Multi-Agent systems · OpenAI · Azure OpenAI · ChromaDB · FAISS · Streamlit

**Machine Learning**
Scikit-Learn · XGBoost · LightGBM · H2O.ai · Prophet · Classification · Regression · Forecasting

**Data Engineering**
PostgreSQL · Apache Airflow · dbt · ETL design · SQL agents · Business Intelligence automation

**Production & Deployment**
FastAPI · Docker · React · Node.js · Azure · AWS · GitHub Copilot

**Healthcare & Compliance**
Epic EMR · HL7/FHIR · HIPAA · GDPR · Clinical data systems · 30+ years healthcare operations
...
| Factor | Detail |
|--------|--------|
| **Production vs. Academic** | 20+ systems live and deployed — not classroom notebooks |
| **Domain Depth** | 30 years of healthcare operations + Epic EMR experience integrated into AI systems |
| **Business Ownership** | 20 years P&L accountability — AI built for ROI, not just accuracy metrics |
| **Real-Time Learning** | 5 concurrent elite programs — skills delivered immediately into production |
| **Global Execution** | Las Vegas US · Marbella Spain · Medellin Colombia · US and EU work authorization |

---

## Engagement

**Open To:** Full-time · Contract · Part-time · Consulting · Strategic Partnerships
**Availability:** Immediate
**Location:** Las Vegas NV · Marbella Spain (primary) · Medellin Colombia · Remote-first
